      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 left-4 w-80 sm:w-96 bg-white/95 backdrop-blur shadow-2xl rounded-3xl border border-rose-100 overflow-hidden z-[60] flex flex-col"
